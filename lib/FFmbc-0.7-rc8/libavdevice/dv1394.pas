...
const 
  DV1394_DEFAULT_CHANNEL = 63;
  DV1394_DEFAULT_CARD    = 0;
  DV1394_RING_FRAMES     = 20;

  DV1394_WIDTH           = 720;
  DV1394_NTSC_HEIGHT     = 480;
  DV1394_PAL_HEIGHT      = 576;

(* This is the public user-space interface. Try not to break it. *)

  DV1394_API_VERSION     = $20011127;
...
(* maximum number of frames in the ringbuffer *)
  DV1394_MAX_FRAMES = 32;

(* number of *full* isochronous packets per DV frame *)
  DV1394_NTSC_PACKETS_PER_FRAME = 250;
  DV1394_PAL_PACKETS_PER_FRAME  = 300;

(* size of one frame's worth of DV data, in bytes *)
  DV1394_NTSC_FRAME_SIZE = (480 * DV1394_NTSC_PACKETS_PER_FRAME);
  DV1394_PAL_FRAME_SIZE  = (480 * DV1394_PAL_PACKETS_PER_FRAME);
...
type
  Tdv1394_status = record
    ...
    first_clear_frame : cuint;

    (* how many buffers, including first_clear_buffer, are
       ready to be filled with data *)
    n_clear_frames : cuint;

    (* how many times the DV stream has underflowed, overflowed,
       or otherwise encountered an error, since the previous call
       to DV1394_GET_STATUS *)
    dropped_frames : cuint;
