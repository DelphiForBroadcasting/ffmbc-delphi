 ...
 *)
function swscale_version(): cunsigned;
  cdecl; external LIB_SWSCALE;
...
function sws_scale_ordered(context: pSwsContext; const src: PPCuint8Array;
                       ...
                       dst: PPCuint8Array; dstStride: PCintArray): cint; deprecated 'Use sws_scale() instead';
	cdecl; external LIB_SWSCALE;
{$IFEND}
 ...
 *)
procedure sws_printVec(a: PSwsVector); deprecated 'Use sws_printVec2() instead';
	cdecl; external LIB_SWSCALE;
{$IFEND}  
