 ...
 *)
function av_cmp_q(a: TAVRational; b: TAVRational): cint; inline;
 ...
 * @return (double) a
 *)
function av_q2d(a: TAVRational): cdouble; inline;
 ...
 *)
function av_nearer_q(q: TAVRational; q1: TAVRational; q2: TAVRational): cint;
  cdecl; external LIB_AVUTIL;
...
function av_find_nearest_q_idx(q: TAVRational; const q_list: PAVRational): cint;
  cdecl; external LIB_AVUTIL;
